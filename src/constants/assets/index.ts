export const ASSETS = {
  ...
  ANIMATIONS: {
    ...
    IO_MOVE_LEFT: 'io-move-left',
    IO_MOVE_RIGHT: 'io-move-right',
    IO_MOVE_UP: 'io-move-up',
    IO_MOVE_DOWN: 'io-move-down',
    PLAYER_IDLE_LEFT: 'player-idle-left',
    PLAYER_IDLE_RIGHT: 'player-idle-right',
    PLAYER_IDLE_UP: 'player-idle-up',
    PLAYER_IDLE_DOWN: 'player-idle-down',
